<%-- 
    Document   : jobListJs
    Created on : Jun 25, 2022, 1:29:19 AM
    Author     : USER
--%>
                           ...
                           <h3 style=" text-align: center;" class="header-title pb-3 mt-0"><b>Job Vacancy Of Kota Bharu Medical Centre</b></h3>
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    String myQuery = "SELECT * FROM job WHERE jobStatus='Available';"; // nak retrieve job yang available sahaja
                                    ResultSet myRs = myStatement.executeQuery(myQuery);
                                    
                                    
                                    out.print("<thead>");
                                    out.print("<tr class=\"align-self-center\">");
                                    out.print("<th>Job ID</th>");
                                    out.print("<th>Job Type</th>");
                                    out.print("<th>Job Title</th>");
                                    out.print("<th>Job Category</th>");
                                    out.print("<th>Job Info</th>");
                                    out.print("<th>Job Salary</th>");
                                    out.print("<th>Job Date Posted</th>");
                                    out.print("<th>Job Status</th>");
                                    ...
                                    out.println("<td><a href=applyJob.jsp?jobID="
                                            + myRs.getString(1) + " style='text-decoration:none;'>Apply</a>"
                                            + "&nbsp;"
