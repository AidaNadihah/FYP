<%-- 
    Document   : allJob
    Created on : Jun 22, 2022, 12:55:02 AM
    Author     : USER
--%>
        ...
        <div class="container">
            ...
            %>
                            ...
                            <div class="pt-3 border-top text-right">
                                <a href="homepage.jsp" style="color: aliceblue;"><button type="button" id="submit" name="submit" class="btn btn-secondary">Back</button></a>
                            </div>
                        </div>
                    </div>
                </div>
